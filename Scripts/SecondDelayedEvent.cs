...
{
	public class SecondDelayedEvent : SOEventListenerWithUnityEventResponse
	{
		[Tooltip("This is relative to the previous delay time, so it happens x seconds after the last event")]
		[SerializeField] protected float secondRelativeDelayTime = 1f;
