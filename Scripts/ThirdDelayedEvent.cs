...
namespace GPInteraction._Scripts.mrstruijk
{
	...
	{
		[Tooltip("This is relative to the previous two delay times, so it happens x seconds after the last event")]
		[SerializeField] private float thirdRelativeDelayTime = 1f;
